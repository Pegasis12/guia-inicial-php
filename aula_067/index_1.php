<?php 
  ...
  */
  ...
  // validar o valor de uma string
  // lembrete: vardump retorna o tipo da saida, se fizemos
  // echo is_string($valor1) a saida seria um com var_dump
  // a saida passa a ser bool(true)
  $valor1 = "João";
  $valor2 = 123;
  ...
  // validar se uma variavel esta vazia
  $valor1 = "Texto";
  $valor2 = "";
  $valor3 = 0;
  $valor4 = 1;
