...
// pra guardar os dados preenchidos, pra por exemplo mostrar se existe erro
// salvar os valores no input etc
session_start();

$inputs = [];

// pergunta se existi esse input na primeira vez, caso n exista ignora tudo
// caso exista entra no if
if (isset($_SESSION["inputs"])) {

  // recolhe a informacao da sessão
  $inputs = $_SESSION["inputs"];

  // remove a informacao para estar vazia em futuros requests
